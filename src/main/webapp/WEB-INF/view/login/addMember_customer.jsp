...
<body>
	...
	<section id="addMember">
        <div class="container">
            <h1>회원가입 <span>  (일반)</span></h1> 
            <p class="title-sub"><span>*</span> 필수항목입력</p> <hr>
            <form name="addMemberForm" class="form"  action="processAddMember_customer" method="post">
                <div class="form-group">
                    <h3>아이디 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input name="id" type="text" class="form-control" placeholder="아이디를 입력해주세요.(4~20자리)" autofocus>
                        <button type="button" class="input-btn" onclick="idCheck()">중복확인</button>
                    </div>
                </div>
                <div class="form-group">
                    <h3>비밀번호 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input name="password" type="password" class="form-control" placeholder="영문, 숫자, 특수문자 조합 8~20자리" >
                    </div>
                </div>
                <div class="form-group">
                    <h3>비밀번호 확인 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input name="password_confirm" type="password" class="form-control" placeholder="비밀번호를 한 번 더 입력해주세요." >
                    </div>
                </div>
                <div class="form-group">
                    <h3>이름 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input name="name" type="text" class="form-control" placeholder="이름을 입력해주세요." >
                    </div>
                </div>
                <div class="form-group">
                    <h3>성별 <span class="essential">*</span></h3>
                    <div class="input-box">
                ...
                <div class="form-group">
                    <h3>생일 <span class="essential">*</span></h3>
                    <div class="input-box">
                    <input type="text" name="year" maxlength="4" placeholder="YYYY" size="4">년 &nbsp;
                        <select name="month">
                        ...
                        <input type="text" name="day" maxlength="2" placeholder="DD" size="2">일
                    </div>
                </div>
                <div class="form-group">
                    <h3>전화번호 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input name="phone" type="text" class="form-control" placeholder="'-'를 제외하고 입력해주세요." >
                    </div>
                </div>
                <div class="form-group" style="min-height: 105px">
                    <h3>주소 <span class="essential">*</span></h3>
                    <div class="input-box">
                        <input type="text" class="readonly" id="postcode" name="postcode" placeholder="우편번호" size="10" readonly style="margin-bottom: 5px;"> 
                        <button type="button" class="input-btn" onclick="findAddr()" style="margin-left: 162px;">주소 검색</button>
                        <input type="text" class="form-control readonly" id="address" name="address" placeholder="주소" readonly style="margin-bottom: 5px;">
                ...
                <div class="form-group">
                    <h3>이메일</h3>
                    <div class="input-box">
                        <input type="text" name="mail1" class="form-control" maxlength="50" placeholder="이메일 앞 부분을 입력해주세요."> @ 
                        <select name="mail2">
                ...
                <div class="form-group">
                    <h3>추천인 ID</h3>
                    <div class="input-box">
                        <input name="recom_id" type="text" class="form-control" placeholder="추천인 아이디를 입력해주세요." >
                    </div>
                </div>
                <div class="form-group">
                    <h3>약관동의 <span class="essential">*</span></h3>
                    <div class="agree-box">
                        <label for="agree_all">
                        ...
                        <button type="button" class="agree-btn">약관보기</button>
                        <div class="agree_modal">
                            ...
                            <p>
                                ...
                                본 약관에 명시되지 않은 사항은 전기통신기본법, 전기통신사업법, 정보통신윤리위원회심의규정, 정보통신 윤리강령, 프로그램보호법 및 기타 관련 법령의 규정에 의합니다.<br><br>
                                ...
                                7. 본 약관에서 정의하지 않은 용어는 개별서비스에 대한 별도 약관 및 이용규정에서 정의합니다.<br><br><br>


                                <b>제 2장 서비스 제공 및 이용</b><br><br>
                                ...
                                5) 기타 국가공간정보포털이 정한 이용신청요건이 미비 되었을 때<br><br>

                                제 6 조 (회원정보 사용에 대한 동의)<br><br>
                                ...
                                3. 회원이 본 약관에 따라 이용신청을 하는 것은, 국가공간정보포털의 신청서에 기재된 회원정보를 수집, 이용하는 것에 동의하는 것으로 간주 됩니다.<br><br>

                                제 7 조 (사용자의 정보 보안)<br><br>
                                ...
                                3. 이용자는 국가공간정보포털 서비스의 사용 종료시마다 정확히 접속을 종료해야 하며, 정확히 종료하지 아니함으로써 제3자가 이용자에 관한 정보를 이용하게 되는 등의 결과로 인해 발생하는 손해 및 손실에 대하여 국가공간정보포털은 책임을 부담하지 아니합니다.<br><br>
                                ...
                                제 9 조 (이용기간 및 자격의 정지 및 상실)<br><br>
                                ...
                                3. 국가공간정보포털 회원이 신청 후 12개월이상 장시간 이용하지 않은 회원은 휴면아이디로 분류하여, 자격 정지 및 상실이 가능합니다.<br><br>

                                제 10 조 (계약해제, 해지 등)<br><br>
                                ...
                                3. 회원이 계약을 해지하는 경우, 회원이 작성한 게시물 중 블로그 등과 같이 본인 계정에 등록된 게시물 일체는 삭제됩니다. 단, 타인에 의해 스크랩 되어 재게시되거나, 공용게시판에 등록된 게시물 등은 삭제되지 않으니 사전에 삭제 후 탈퇴하시기 바랍니다.<br><br>

                                제 11 조 (게시물의 저작권)<br><br>

                                1. 이용자가 게시한 게시물의 저작권은 이용자가 소유하며, 국가공간정보포털는 서비스 내에 이를 게시할 수 있는 권리를 갖습니다.<br>
                                2. 국가공간정보포털은 다음 각 호에 해당하는 게시물이나 자료를 사전통지 없이 삭제하거나 이동 또는 등록 거부를 할 수 있습니다.<br>
                                ...
                                3. 이용자의 게시물이 타인의 저작권을 침해함으로써 발생하는 민, 형사상의 책임은 전적으로 이용자가 부담하여야 합니다.<br><br><br>


                                <b>제 3장 의무 및 책임</b><br><br>


                                제 12 조 (국가공간정보포털의 의무)<br><br>
                                ...
                                2. 회원은 국가공간정보포털의 사전 승낙없이 서비스를 이용하여 어떠한 영리행위도 할 수 없으며, 그 영업활동의 결과에 대해 국가공간정보포털은 일절 책임을 지지 않습니다. 또한 회원은 이와 같은 영업활동으로 국가공간정보포털이 손해를 입은 경우 손해배상의무를 지며, 국가공간정보포털은 해당 회원에 대해 서비스 이용제한 및 적법한 절차를 거쳐 손해배상 등을 청구할 수 있습니다.<br>
                                3. 회원은 국가공간정보포털 서비스 이용과 관련하여 다음 각 호의 행위를 하여서는 안됩니다.<br>
                                ...
                                회원이 서비스의 이용권한, 기타 이용계약 상 지위를 타인에게 양도, 증여할 수 없습니다.<br><br>
                                ...
                                3. 국가공간정보포털은 이용자간 또는 이용자와 제3자간에 서비스를 매개로 하여 물품거래 혹은 금전적 거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 이용자가 서비스의 이용과 관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다.<br><br>

                                제 16 조 (재판관할)<br><br>

                                국가공간정보포털과 이용자간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 민사소송법상의 관할법원에 제기합니다.<br>
                        ...
                        <div class="agree_modal">
                            <div class="flex">
                                <h1 class="title">개인정보 수집 및 이용에 대한 안내</h1>
                                <button class="close" type="button">×</button>
                            </div>
                            <p>
                                ...
                                1) 공간정보 다운로드, 오픈API 신청 및 활용 등 포털 서비스 제공과 서비스 부정이용 방지를 목적으로 개인정보를 처리합니다.<br><br>

                                <b>나. 정보주체와 법정대리인의 권리ㆍ의무 및 행사방법</b><br>
                                ...
                                <b>다. 수집하는 개인정보의 항목</b><br>
                                ① 국가공간정보포털 회원정보(필수): 이름, 이메일(아이디), 비밀번호<br>

                                <b>라. 개인정보의 보유 및 이용기간</b><br>
                                ...
                                <b>마. 동의 거부 권리 및 동의 거부에 따른 불이익</b><br>
                                위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
                            </p>
                        </div>
                        <br><br>
                        <label for="agree3">
                            <input type="checkbox" name="agree3" id="agree3" value="3">
                            <span>이벤트, 혜택정보 수신동의<strong> (선택)</strong></span>
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    <button type="button" class="submit" onclick="validate();">가입하기</button>
                </div>
            </form>
        </div>
    </section>
