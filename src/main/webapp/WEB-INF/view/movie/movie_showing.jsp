...
<body>
    ...
    <section id="section02">
        <div class="container">
            <div class="head">
                <div class="flex">
                    ...
                    <%
	                    ...
	                    if(admincheck == "true"){ 
	                %>
						<a href="addMovie_showing" class="addBtn addBtn01 view">영화등록</a>
						<a href="addMovie_coming" class="addBtn addBtn02">영화등록</a>
					<%
						} else{
					%>
						<p class="sub">인기순</p>
            ...
            <div id="showing" class="section tap-view">
                <ul class="list">
