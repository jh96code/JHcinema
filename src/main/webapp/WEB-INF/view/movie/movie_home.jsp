...
<head>
	...
	<link rel="stylesheet" href="./resources/css/movie_home.css"/>
...
<body>
    ...
    <section id="section02" class="section">
        <div class="container">
            <div class="head">
                <div class="flex">
                    <p class="title">현재 상영작 <span>TOP 5</span></p>
                    <a href="movie_showing" class="more">더보기 ></a>
                </div>
            </div>
            <ul class="list">
            	<c:forEach var="showingList" items="${showingList}" varStatus="status" end="4">
                    <li>
    ...
    <section id="section03" class="section">
        <div class="container">
            <div class="head">
                <div class="flex">
                    <p class="title">상영 예정작 <span>TOP 5</span></p>
                    <a href="movie_coming" class="more">더보기 ></a>
                </div>
            </div>
            <ul class="list">
            	<c:forEach var="comingList" items="${comingList}" varStatus="status" end="4">
                    <li>
